...
//proderpharma
   ...
   //searle
    ...
    render(){
        let btn_class = this.state.eme ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class2 = this.state.abott ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class3 = this.state.alcon ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class4 = this.state.almiral ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class5 = this.state.aspen ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class6 = this.state.aventis ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class7 = this.state.astra ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class8 = this.state.bago ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class9 = this.state.bayer ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class10 = this.state.bial ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class11 = this.state.bussie ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class12 = this.state.covidien ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class13 = this.state.detector ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class14 = this.state.euromed ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class15 = this.state.eurotest ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class16 = this.state.fleet ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class17 = this.state.galderma ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class18 = this.state.gnoma ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class19 = this.state.genzyme ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class20 = this.state.grifols ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class21 = this.state.grunenthal ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class22 = this.state.gsk ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class23 = this.state.lafrancol ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class24 = this.state.lasante ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class25 = this.state.lilly ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class26 = this.state.mead ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class27 = this.state.medice ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class28 = this.state.medix ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class29 = this.state.merck ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class30 = this.state.microlife ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class31 = this.state.msd ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class32 = this.state.novartis ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class33 = this.state.nutricia ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class34 = this.state.pfizer ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class35 = this.state.pharma ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class36 = this.state.promeco ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class37 = this.state.qc ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class38 = this.state.roche ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class39 = this.state.roemmers ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class40 = this.state.sandoz ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class41 = this.state.sanofis ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class42 = this.state.schering ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class43 = this.state.stiefel ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class44 = this.state.swissfarm ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class45 = this.state.talecris ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        let btn_class46 = this.state.unipharm ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
        ...
        let btn_class86 = this.state.steriscrub ? "bg-danger card card3 pointer" : "bg-azul card card3 pointer";
