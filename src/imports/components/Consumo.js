...
changeColor80(){
  ...
  this.setState({woodbridge:!this.state.woodbridge})
    ...
    render(){
        let btn_class = this.state.alka ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class2 = this.state.carefree ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class3 = this.state.casillero ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class4 = this.state.clean ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class5 = this.state.colombina ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class6 = this.state.concha ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class7 = this.state.derma ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class8 = this.state.desitin ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class9 = this.state.dove ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class10 = this.state.dvant ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class11 = this.state.jimador ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class12 = this.state.evenflo ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class13 = this.state.ferrero ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class14 = this.state.glad ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class15 = this.state.herradura ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class16 = this.state.hershey ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class17 = this.state.hormel ? "bg-danger card pointer" : "bg-azul card card-3 pointer";
        let btn_class18 = this.state.hyde ? "bg-danger card  pointer" : "bg-azul card card-3 pointer";
        let btn_class19 = this.state.john ? "bg-danger card  pointer" : "bg-azul card card-3 pointer";
