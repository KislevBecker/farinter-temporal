...
changeColor80(){
  ...
  this.setState({woodbridge:!this.state.woodbridge})
    ...
    render(){
        ...
        let btn_class2 = this.state.carefree ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class3 = this.state.casillero ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class4 = this.state.clean ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class5 = this.state.colombina ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class6 = this.state.concha ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class7 = this.state.derma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class8 = this.state.desitin ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class9 = this.state.dove ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class10 = this.state.dvant ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class11 = this.state.jimador ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class12 = this.state.evenflo ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class13 = this.state.ferrero ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class14 = this.state.glad ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class15 = this.state.herradura ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class16 = this.state.hershey ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class17 = this.state.hormel ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class18 = this.state.hyde ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class19 = this.state.john ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class20 = this.state.juisy ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class21 = this.state.kisses ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class22 = this.state.listerine ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class23 = this.state.lubriderm ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class24 = this.state.lysol ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class25 = this.state.mm ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class26 = this.state.madonna ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class27 = this.state.maruchan ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class28 = this.state.mcormick ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class29 = this.state.milky ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class30 = this.state.nestle ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class31 = this.state.nivea ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class32 = this.state.nodor ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class33 = this.state.orbit ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class34 = this.state.pedigree ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class35 = this.state.ponds ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class36 = this.state.pringles ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class37 = this.state.rexona ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class38 = this.state.sangre ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class39 = this.state.sedal ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class40 = this.state.skittles ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class41 = this.state.snickers ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class42 = this.state.splenda ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class43 = this.state.star ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class44 = this.state.stayfree ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class45 = this.state.summer ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class46 = this.state.treseme ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class47 = this.state.twix ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class48 = this.state.tylenol ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class49 = this.state.unilever ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
