...
import logoCovidien from '../../img/farma/COVIDIEN.png';
...
//proderpharma
   ...
   //searle
    ...
    render(){
        let btn_class = this.state.eme ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class2 = this.state.abott ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class3 = this.state.alcon ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class4 = this.state.almiral ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class5 = this.state.aspen ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class6 = this.state.aventis ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class7 = this.state.astra ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class8 = this.state.bago ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class9 = this.state.bayer ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class10 = this.state.bial ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class11 = this.state.bussie ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class12 = this.state.covidien ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class13 = this.state.detector ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class14 = this.state.euromed ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class15 = this.state.eurotest ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class16 = this.state.fleet ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class17 = this.state.galderma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class18 = this.state.gnoma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class19 = this.state.genzyme ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class20 = this.state.grifols ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class21 = this.state.grunenthal ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class22 = this.state.gsk ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class23 = this.state.lafrancol ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class24 = this.state.lasante ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class25 = this.state.lilly ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class26 = this.state.mead ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class27 = this.state.medice ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class28 = this.state.medix ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class29 = this.state.merck ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class30 = this.state.microlife ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class31 = this.state.msd ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class32 = this.state.novartis ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class33 = this.state.nutricia ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class34 = this.state.pfizer ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class35 = this.state.pharma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class36 = this.state.promeco ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class37 = this.state.qc ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class38 = this.state.roche ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class39 = this.state.roemmers ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class40 = this.state.sandoz ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class41 = this.state.sanofis ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class42 = this.state.schering ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class43 = this.state.stiefel ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class44 = this.state.swissfarm ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class45 = this.state.talecris ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class46 = this.state.unipharm ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class47 = this.state.vifor ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class48 = this.state.vitotal ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class49 = this.state.wyeth ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class50 = this.state.ashonplafa ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class51 = this.state.astamedica ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class52 = this.state.bayerhealth ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class53 = this.state.biokemical ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class54 = this.state.biopas ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class55 = this.state.bonima ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class56 = this.state.cheplapharm ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class57 = this.state.church ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class58 = this.state.clement ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class59 = this.state.drifarma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class60 = this.state.farmitalia ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class61 = this.state.grupopharma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class62 = this.state.hoeschst ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class63 = this.state.jpharma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class64 = this.state.lederle ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class65 = this.state.leo ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class66 = this.state.lundbeck ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class67 = this.state.md ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class68 = this.state.mepha ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class69 = this.state.nestlecarribean ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class70 = this.state.om ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class71 = this.state.owen ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class72 = this.state.panalab ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class73 = this.state.parkedavis ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class74 = this.state.pasmo ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class75 = this.state.pharmanova? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class76 = this.state.procaps ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class77 = this.state.proderpharma ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class78 = this.state.rhone ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class79 = this.state.roussel ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class80 = this.state.rowe ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class81 = this.state.searle ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
        let btn_class82 = this.state.servier ? "bg-danger card card-3 pointer" : "bg-azul card card-3 pointer";
...
<div className="row mb-3">
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
                <div className={btn_class51} onClick={this.changeColor51.bind(this)}  data-toggle="modal" data-target="#astamedica">
                    <img src={astamedica}  className="p-2 w-100 w-50-xs-md center" alt="..." />
                </div>
            </div>
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
...
<div className="row mb-3">
            ...
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
                <div className={btn_class55} onClick={this.changeColor55.bind(this)} data-toggle="modal" data-target="#bonima" >
                    <img src={bonima}  className="p-2 w-75 w-50-xs-md center" alt="..." />
                </div>
            </div>
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
            ...
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
                <div className={btn_class56} onClick={this.changeColor56.bind(this)}  data-toggle="modal" data-target="#cheplapharm">
                    <img src={cheplafarm}  className="p-2 w-100 w-50-xs-md center" alt="..." />
                </div>
            </div>
        </div>    
        ...
        <div className="row mb-3">
            ...
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
                <div className={btn_class65} onClick={this.changeColor65.bind(this)}  data-toggle="modal" data-target="#leo">
                    <img src={leo}  className="p-2 w-100 w-50-xs-md center" alt="..." />
                </div>
            </div>
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
          ...
          <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
            ...
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
                <div className={btn_class69} onClick={this.changeColor69.bind(this)}  data-toggle="modal" data-target="#nestlecarribean">
                    <img src={nestlecaribean}  className="p-2 w-75 w-50-xs-md center" alt="..." />
                </div>
            </div>
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
        ...
        <div className="row mb-3">
            ...
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
                <div className={btn_class84} onClick={this.changeColor84.bind(this)}  data-toggle="modal" data-target="#ucb">
                    <img src={ucb}  className="p-2 w-75 w-50-xs-md center" alt="..." />
                </div>
            </div>
            <div className= "col-md-2 col-sm-4 col-xs-3 mt-1">
  ...
  <div className="modal-dialog modal-dialog-centered modal-lg">
    <div className="modal-content2">
      ...
      <button type="button" className="close2 border-0" onClick={this.changeColor11.bind(this)} data-dismiss="modal" aria-label="Close">
       ...
       <div className="row">
           <div className="col-md-12">
           <img src={logoBussie}  className="img-fluid"  alt="..." />
           </div>
       </div>
      </div>
    </div>
  ...
  <div className="modal-dialog modal-dialog-centered modal-lg">
    <div className="modal-content2">
      ...
      <button type="button" className="close2 border-0" onClick={this.changeColor12.bind(this)} data-dismiss="modal" aria-label="Close">
       ...
       <div className="row">
           <div className="col-md-12">
           <img src={logoCovidien}  className="img-fluid" alt="..." />
           </div>
       </div>
      </div>
    </div>
