...
<section className="pt-5 pb-5">
 ...
 <div className="carousel-item"  data-interval="5000">
            ...
            <a className="carousel-control-prev carrusel-izq" href="#carouselExampleIndicators3" role="button" data-slide="prev">
              <i className="fas fa-angle-left text-primary fa-2x"></i>
              <span className="sr-only">Previous</span>
            </a>
            <a className="carousel-control-next carrusel-der" href="#carouselExampleIndicators3" role="button" data-slide="next">
