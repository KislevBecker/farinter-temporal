...
//madonna
  ...
  changeColor52(){
    ...
    render(){
        let btn_class = this.state.alka ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class2 = this.state.carefree ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class3 = this.state.casillero ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class4 = this.state.clean ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class5 = this.state.colombina ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class6 = this.state.concha ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class7 = this.state.derma ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class8 = this.state.desitin ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class9 = this.state.dove ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class10 = this.state.dvant ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class11 = this.state.jimador ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class12 = this.state.evenflo ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class13 = this.state.ferrero ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class14 = this.state.glad ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class15 = this.state.herradura ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class16 = this.state.hershey ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class17 = this.state.hormel ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class18 = this.state.hyde ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class19 = this.state.john ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class20 = this.state.juisy ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class21 = this.state.kisses ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class22 = this.state.listerine ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class23 = this.state.lubriderm ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class24 = this.state.lysol ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class25 = this.state.mm ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class26 = this.state.madonna ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class27 = this.state.maruchan ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class28 = this.state.mcormick ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class29 = this.state.milky ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class30 = this.state.nestle ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class31 = this.state.nivea ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class32 = this.state.nodor ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class33 = this.state.orbit ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class34 = this.state.pedigree ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class35 = this.state.ponds ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class36 = this.state.pringles ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class37 = this.state.rexona ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class38 = this.state.sangre ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class39 = this.state.sedal ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class40 = this.state.skittles ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class41 = this.state.snickers ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class42 = this.state.splenda ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class43 = this.state.star ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class44 = this.state.stayfree ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class45 = this.state.summer ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class46 = this.state.treseme ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class47 = this.state.twix ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class48 = this.state.tylenol ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class49 = this.state.unilever ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class50 = this.state.vitacreme ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class51 = this.state.whiskas ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
        let btn_class52 = this.state.wrigley ? "bg-danger card card-2 pointer" : "bg-azul card card-2 pointer";
...
<section className="pt-5 pb-5">
  <div className="container">
    <div className="row">
        <div className="col-6">
            <h3 className="mb-3 text-primary">Catálogo de proveedores consumo </h3>
        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                              <div className={btn_class4} onClick={this.changeColor4.bind(this)} data-toggle="modal" data-target="#cleanC">
                                <img src={cleanC}  className="p-2 w-100 center" alt="..." />
                              </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                          <div className="col-md-3 mb-3">
                            <div className={btn_class13} onClick={this.changeColor13.bind(this)} data-toggle="modal" data-target="#ferrero">
                              <img src={FERRERO}  className="p-2 w-100 center" alt="..." />
                            </div>
                          </div>
                            <div className="col-md-3 mb-3">
                            ...
                            <div className="col-md-3 mb-3">
                              <div className={btn_class15} onClick={this.changeColor15.bind(this)} data-toggle="modal" data-target="#herradura">
                                <img src={HERRADURA}  className="p-2 w-75 center" alt="..." />
                              </div>
                            </div>
                          <div className="col-md-3 mb-3">
                      ...
                      <div className="row">
                        <div className="col-md-3 mb-3">
                          <div className={btn_class17} onClick={this.changeColor17.bind(this)}  data-toggle="modal" data-target="#hormel">
                            <img src={HORMEL}  className="p-2 w-100 center" alt="..." />
                          </div>
                        </div>
                        <div className="col-md-3 mb-3">
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-3 mb-3">
                            <div className={btn_class36} onClick={this.changeColor36.bind(this)} data-toggle="modal" data-target="#pringles">
                              <img src={PRINGLES}  className="p-2 w-75 center" alt="..." />
                            </div>
                          </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                          <div className="col-md-3 mb-3">
                            <div className={btn_class37} onClick={this.changeColor37.bind(this)} data-toggle="modal" data-target="#rexona">
                              <img src={rexona}  className="p-2 w-100 center" alt="..." />
                            </div>
                          </div>
                          <div className="col-md-3 mb-3">
                        ...
                        <div className="row">
                          <div className="col-md-3 mb-3">
                            <div className={btn_class49} onClick={this.changeColor49.bind(this)}  data-toggle="modal" data-target="#unilever">
                              <img src={unilever}  className="p-2 w-75 center" alt="..." />
                            </div>
                          </div>
                          <div className="col-md-3 mb-3">
