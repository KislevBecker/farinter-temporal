...
<section className="pt-5 pb-5">
  ...
  <div className="row no-gutters">
        ...
        <div className="col-12">
            <div id="carouselExampleIndicators2" className="carousel slide w-75" data-ride="carousel">
